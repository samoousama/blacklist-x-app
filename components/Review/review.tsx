...
import Avatar from "../../app/img/testimonials.png"
            ...
            <div className="border border-[#9999992E] rounded-[10px] overflow-hidden shadow-2xl shadow-[#000000D4]">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <div className="flex items-center">
                        <svg className="w-6 h-6 md:w-[20px] md:h-[20px] ms-2 text-yellow-300" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 22 20">
                        ...
                        <svg className="w-6 h-6 md:w-[20px] md:h-[20px] ms-2 text-gray-300 dark:text-gray-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 22 20">
                            <path d="M20.924 7.625a1.523 1.523 0 0 0-1.238-1.044l-5.051-.734-2.259-4.577a1.534 1.534 0 0 0-2.752 0L7.365 5.847l-5.051.734A1.535 1.535 0 0 0 1.463 9.2l3.656 3.563-.863 5.031a1.532 1.532 0 0 0 2.226 1.616L11 17.033l4.518 2.375a1.534 1.534 0 0 0 2.226-1.617l-.863-5.03L20.537 9.2a1.523 1.523 0 0 0 .387-1.575Z"/>
                        </svg>
                    </div>
                </div>
                <div className="py-[10px] text-white">
                    <strong>Lucas Patel</strong> On <strong>Reading Plus</strong>
                </div>
