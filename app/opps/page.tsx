...
const Opps = () => {
  return (
    <div className="min-h-screen bg-[url('img/sec-bg.png')] bg-no-repeat bg-cover sm:px-[10px] md:px-[10px]">
      ...
      <div className="pt-[40px]">
        <div className="w-full max-w-6xl mx-auto px-4 md:px-6 py-10">
            <div className="text-center">
                <div className="font-extrabold sm:text-[30px] text-[50px] sm:text-[20px] sm:leading-[30px] leading-[70px] md:text-4xl [text-wrap:balance] bg-clip-text text-[#fff] "><span className="bg-gradient-to-t from-[#CFC3FF] to-[#492EB4] text-transparent bg-clip-text">Oops!</span> We dont have a verified review for that yet </div>                
            </div>
        </div>
      ...
      <div>
      <div className="max-w-[785px] sm:w-full m-auto rounded-[10px] overflow-hidden mt-[50px] shadow-2xl shadow-[#5C94FF45] bg-gradient-to-t from-[#5D40D6] to-[#AC99FF] p-[2px] rounded-[15px]">
          <div className="py-[30px] px-[50px] bg-[url('img/search-bg.png')] bg-no-repeat bg-cover sm:bg-cover sm:px-[15px] sm:bg-[length:100%_100%] rounded-[15px]">
